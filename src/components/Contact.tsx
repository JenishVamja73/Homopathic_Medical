            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Monark University Campus,<br />
                    Medical Education Complex,<br />
                    University Road, Education City,<br />
                    State - 382481, India
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    General: +91-9876543211<br />
                    International: +91-9876543212
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    admissions@monarkuniversity.edu<br />
                    info@monarkuniversity.edu<br />
                    research@monarkuniversity.edu
                  </p>
                </div>
              </div>
